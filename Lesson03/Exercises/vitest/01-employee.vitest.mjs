...
// cpr 10 digits
//        cpr setter test value --> 1234561234 --> 10 digits = valid
//        cpr setter test value --> 0, "", " ", abc, NaN, undefined, 123456-1234 = invalid
//        cpr getter test value --> 10 digits = valid
// 
// First name >=1 && <= 30 chars: alphabet, '-' or spaces
//        FName setter test values --> "Anne-Mette Skov" --> 15 chars including spaces and dash = valid
//        FName setter test values --> "Anne1", 123, "", (whitespace), " ", "-", "- ", "%", "@", undefined, "<>/" = invalid
// 
// !ignorer Last name, da det er samme funk som first name...!
// Last name >=1 && <= 30 chars: alphabet, '-' or spaces
//        LName setter test values --> "Hansen Himmel-blå" --> 17 chars including spaces and dash = valid
//        LName setter test values --> "Anne1", 123, "", (whitespace), " ", "-", "- ", "%", "@", undefined, "<>/" = invalid
//
...
//        boundaries: 9, 10, 11,
//
// firstname: >=1 && <= 30 chars
//        boundaries: 0, 1, 2, 29, 30, 31 (string.length)
//
// lastname: >=1 && <= 30 chars
//        boundaries: 0, 1, 2, 29, 30, 31 (string.length)
